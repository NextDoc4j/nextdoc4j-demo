...
@Tag(name = "WebFlux 演示")
public class Nextdoc4jDemoWebFluxSb4Application {

    public static void main(String[] args) {
        SpringApplication.run(Nextdoc4jDemoWebFluxSb4Application.class, args);
    }

    @GetMapping("/hello")
    @Operation(summary = "返回单个响应式结果")
    public Mono<Map<String, String>> hello() {
        return Mono.just(Map.of("message", "NextDoc4j Spring Boot 4 WebFlux"));
    }
